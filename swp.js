/*
================================================================================
  SHIPPING WITH PURPOSE — swp.js
  Shared JavaScript for all 4 pages.
  Include as: <script src="swp.js" defer></script>
================================================================================
*/
...
(function initQuote() {
  ...
  function updateQuote() {
    ...
    document.querySelectorAll('.term-btn').forEach(btn => {
      btn.classList.toggle('active', btn.dataset.term === selectedTerm);
    });
    ...
    if (addonBtn) addonBtn.classList.toggle('active', notifications);
  }
